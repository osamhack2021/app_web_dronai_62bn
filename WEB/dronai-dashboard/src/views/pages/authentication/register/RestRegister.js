        ...
        <React.Fragment>
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    email: Yup.string().email('올바른 이메일 주소를 입력하세요!').max(255).required('이메일 주소를 입력하세요'),
                    username: Yup.string().required('유저 이름을 입력하세요'),
                ...
                {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                    <form noValidate onSubmit={handleSubmit} {...others}>
                        ...
                        <FormControl fullWidth error={Boolean(touched.username && errors.username)} className={classes.loginInput}>
                            <InputLabel htmlFor="outlined-adornment-username-register">유저 이름</InputLabel>
                            <OutlinedInput
