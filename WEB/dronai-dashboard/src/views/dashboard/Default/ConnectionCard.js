...
import SkeletonConnectionCard from '../../../ui-component/cards/Skeleton/ConnectionCard';

// assets
import ConnectionIcon from './../../../assets/images/icons/wave.svg';
...
const ConnectionCard = ({ isLoading }) => {
                            ...
                            <Grid container justifyContent="space-between">
                                <Grid item>
                                    <Avatar variant="rounded" className={classes.avatar}>
                                        <img src={ConnectionIcon} alt="Notification" />
                                    </Avatar>
                                </Grid>
                                <Grid item>
                                    <Avatar
